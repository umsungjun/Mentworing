...
<script type='text/javascript'>
	function functionC(mentorname, mentorprofile, memberprofile) {
		...
		sessionStorage.setItem('memberprofile', memberprofile); // 세션 등록
		sessionStorage.setItem('mentorprofile', mentorprofile); // 세션 등록
...
<body>
	...
	%>
		...
		<div class="lecture_review_container">
			<div class="lecture_review_wrapper">
				<a href="../Mentor/Mentorview?mno=${mno}" id="choose_btn">강의</a> <a
					href="../Mentor/Mentorview_Review?mno=${mno}">후기</a>
			</div>
		</div>
		<div class=mentor_view_content_nav>
			<div class="mentor_view_content_header_container">
				<div class="mentor_view_content_header">
					<a class="mentor_view_content_header_title" href="#"> <span>${mentorname}
		...
		<form class="mentorview_container" action="../Mentor/Mentorview"
			method="POST" onsubmit="return movebasket(this);">
	...
	<div class="mentorview_body">
		...
		<div class="basketbutton" id="metor_ver_basket_btn">
	...
	<input type="text" id="sessionname" value="${name}">
	<!-- 채팅 포함 -->
			<div class='Login_popup'>
	...
	<div class="cont">
		<div class="stars">
			...
			<form action="../board/Mentor_Review"
				...
				<div class="rev-box">
					<textarea class="review" col="30" id="textarea" name="content"
						onkeyup="bgcolor_yellow(this)"></textarea>
