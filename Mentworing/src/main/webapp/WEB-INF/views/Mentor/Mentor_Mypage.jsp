...
<body onload="errCodeCheck('${msgCode}');">
	...
	<!-- 헤더부분 -->
	<div class="metor_mypage__body">
		<div class="mentee_mypage_title_container">
			<div class="mentee_mypage_title_wraper">
				<span class=mentee_mypage_title_title>Modifying information</span> <span
					class=mentee_mypage_title_subtitle>개인정보를 수정할 수 있습니다.</span>
			</div>
		</div>
		...
		<div class="metee_mypage_side_wraper">
			...
			<button onclick="location.href='../Mentor/Mentor_Mypage'" id="selet_my_upload_lecture">개인정보수정</button>
		...
		<div class="metor_mypage_join_form">

			<form id="metor_mypage_join_form_from" name="joinForm" method=post
				Action='mentee_Mypage' enctype="multipart/form-data">
						...
						<input class="myPageInputBox" maxlength=20 size=20 id='reg_mb_id' name="id" class="ed"
						...
						<input name="name" placeholder="name"
							value="${user.name}" readonly  class="myPageInputBox" required>
						...
						<input class="myPageInputBox" type=text
								...
								<a href="javascript:;" Onclick='DaumPostcode()' class="address_btn_mentor"><i class="fa-solid fa-location-dot"></i></a>
							
						<input class="myPageInputBox" type=text id="addr1" value='${user.addr1}' readonly
						...
						<input class="myPageInputBox"
							...
							<div id="image_container">
									<img class="img"
										src="https://infruntest.s3.ap-northeast-2.amazonaws.com/${memberprofile}">
								</div>
